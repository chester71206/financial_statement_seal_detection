...
detector = StampDetector(
    weights_path='./Yolov4_best.pth',
    num_classes=1,
    class_names_path='data/custom.names',
    conf_thresh=0.1, # 這裡設定的信心分數閾值，會被 get_stamp_positions 使用
    gpu_id='0'
)
print("檢測器準備就緒！")

# --- 步驟 2: 讀取圖片並呼叫檢測器 (這部分不變) ---
image_path = r"C:\Users\chester\Desktop\commeet\全部公司四大報表_灰階_JPG_add_noise_hard\貿聯-KY_2024_合併_綜合損益表_1.jpg"
