...
def add_noise_only(input_path, out_path, add_noise=True, seed=42):
    ...
    if add_noise:
        ...
        # 細鹽胡椒噪
        noise_level = 0.1 # 雜訊密度，0.001 表示 0.1% 的像素會被翻轉(hard)
...
if __name__ == "__main__":
    ...
    input_dir = Path(r"/home/chester/pytorch-YOLOv4/全部公司四大報表_灰階_JPG")
    # 建議輸出資料夾名稱可以更明確
    output_dir = Path(r"/home/chester/pytorch-YOLOv4/全部公司四大報表_灰階_JPG_add_noise_very_very_hard")
